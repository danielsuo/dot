...
hyper:bind({ 'cmd' }, 'H', nil, dispatch_url('messenger.com'))
hyper:bind({}, 'I', launch_app('Messages'))
hyper:bind({}, 'J', dispatch_url('goto2.corp.google.com/jaxplorations'))
hyper:bind({ 'cmd' }, 'J', nil, launch_app('Jetski'))
hyper:bind({}, 'L', dispatch_url('calendar.google.com'))
hyper:bind({ 'cmd' }, 'L', nil, dispatch_url('calendar.google.com/calendar/u/1'))
